...
(function () {
	...
	function adder() {
		return [
			...
			'<input id="cp-url" class="cp-code" type="text" inputmode="url" placeholder="https://…" spellcheck="false"',
			' style="flex:1 1 260px;min-width:0;padding:9px 12px" value="' + esc(draftUrl) + '" />',

...
- [ ] Study: Copilot Code Review feature; how to trigger, feedback mechanism
- [ ] Study: Pull Request summaries; customizable review standards
- [ ] Study: Copilot Spaces and Spark (what they are, when to use)
- [ ] Practice: 23 questions (--day-lock 5)
- Estimated time: 2 hrs
